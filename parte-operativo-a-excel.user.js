...
(function () {
    ...
    function inyectarCamposGenerales() {
        ...
        bloque.innerHTML = `
            <h4 style="color:#217346;margin-top:0;margin-bottom:15px;border-bottom:1px solid #217346;padding-bottom:5px;">Datos adicionales (para Excel)</h4>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
                <div class="form_datos">
                    <label style="font-weight:bold;font-size:0.9em;" for="excel-tipo-intervencion">Tipo de Intervención</label><br>
                    <select id="excel-tipo-intervencion" style="width:100%;padding:5px;">
                        <option value="">${VACIO}</option>
                        ${OPCIONES_INTERVENCION.map(o => `<option value="${o}">${o}</option>`).join("")}
                    </select>
                </div>
                <div class="form_datos">
                    <label style="font-weight:bold;font-size:0.9em;" for="excel-detalle-direccion">Detalle Dirección</label><br>
                    <select id="excel-detalle-direccion" style="width:100%;padding:5px;">
                        <option value="">${VACIO}</option>
                        ${OPCIONES_DETALLE_DIRECCION.map(o => `<option value="${o}">${o}</option>`).join("")}
                    </select>
                </div>
                <div class="form_datos">
                    <label style="font-weight:bold;font-size:0.9em;" for="excel-juzgado">Juzgado</label><br>
                    <input type="text" id="excel-juzgado" style="width:100%;padding:5px;box-sizing:border-box;">
                </div>
                <div class="form_datos">
                    <label style="font-weight:bold;font-size:0.9em;" for="excel-secretaria">Secretaría</label><br>
                    <input type="text" id="excel-secretaria" style="width:100%;padding:5px;box-sizing:border-box;">
                </div>
            </div>
        `;
    ...
    function filasDelDomicilio(numDire, gen) {
        ...
        for (let i = 1; i <= totalFilas; i++) {
            ...
            const imp = datosImputado(numDire, i, []); // Alias eliminado
            ...
            const fila = [
                ...
                imp ? imp.apellido : "", imp ? imp.nombre : "", "", imp ? imp.sexo : "",
